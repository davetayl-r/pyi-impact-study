# ========================================================================================= #
# PYI Impact Study                                                                          #
# Model outcome: in_housing_spell_on_date_18 using a full matched sample                    #
# Author: David Taylor                                                                      #
# Date: 24/01/2025                                                                          #
# ========================================================================================= #
...
saveRDS(
  ...
  "U:/pyi-paper/output/treatment_effect_results/in_housing_spell_on_date_18_te_results_full_match.RDS"
)
...
saveRDS(
  ...
  "U:/pyi-paper/output/treatment_effect_results/in_housing_spell_on_date_18_subgroup_sex_results_full_match.RDS"
)
...
saveRDS(
  ...
  "U:/pyi-paper/output/treatment_effect_results/in_housing_spell_on_date_18_subgroup_aboriginal_results_full_match.RDS"
)
...
saveRDS(
  ...
  "U:/pyi-paper/output/treatment_effect_results/in_housing_spell_on_date_18_subgroup_housing_vulnerability_results_full_match.RDS"
)
...
saveRDS(
  ...
  "U:/pyi-paper/output/sensitivity_analysis/in_housing_spell_on_date_18_tip_results_full_match.RDS"
)
...
saveRDS(
  ...
  "U:/pyi-paper/output/plot_data/in_housing_spell_on_date_18_smd_results_full_match.RDS"
)
