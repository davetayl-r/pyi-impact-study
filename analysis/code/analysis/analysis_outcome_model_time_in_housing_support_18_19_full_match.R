# ========================================================================= #
# PYI Impact Study                                                          #
# Model outcome: time_in_housing_support_18_19 using a full matched sample  #
# Author: David Taylor                                                      #
# Date: 24/01/2025                                                          #
# ========================================================================= #
...
time_in_housing_support_18_19_smd_att_boot <- boot(
  pair_ids,
...
# get smd
time_in_housing_support_18_19_model_att_smd <- time_in_housing_support_18_19_smd_att_boot$t0 |>
  as_tibble() |>
  as.numeric()

# get boot se
time_in_housing_support_18_19_model_att_smd_se <- time_in_housing_support_18_19_smd_att_boot$t |>
  as_tibble() |>
  rename(
    "smd" = 1
  ) |>
...
time_in_housing_support_18_19_smd_att_boot_ci <- boot.ci(
  time_in_housing_support_18_19_smd_att_boot, 
  type = "bca",
  index = 1)

# extract data
time_in_housing_support_18_19_model_att_smd_ci_low <- time_in_housing_support_18_19_smd_att_boot_ci$bca[4]
time_in_housing_support_18_19_model_att_smd_ci_high <- time_in_housing_support_18_19_smd_att_boot_ci$bca[5]
...
saveRDS(
  ...
  "U:/pyi-paper/output/treatment_effect_results/time_in_housing_support_18_19_te_results_full_match.RDS"
)
...
bootstrap_standardised_mean_difference_sex <- function(pairs, i) {
  ...
  male_intervention_sd <- weighted_sd(
    x = subset(outcome_data_male, pyi_flag == 1)$time_in_housing_support_18_19,
    w = subset(outcome_data_male, pyi_flag == 1)$weights
  )
  
  male_comparison_sd <- weighted_sd(
    x = subset(outcome_data_male, pyi_flag == 0)$time_in_housing_support_18_19,
    w = subset(outcome_data_male, pyi_flag == 0)$weights
  )
  
  female_intervention_sd <- weighted_sd(
    x = subset(outcome_data_female, pyi_flag == 1)$time_in_housing_support_18_19,
    w = subset(outcome_data_female, pyi_flag == 1)$weights
  )
  
  female_comparison_sd <- weighted_sd(
    x = subset(outcome_data_female, pyi_flag == 0)$time_in_housing_support_18_19,
...
# get smd
time_in_housing_support_18_19_model_att_smd <- count_total_housing_spells_smd_att_boot_sex$t0

# get boot se
time_in_housing_support_18_19_model_att_smd_se <- count_total_housing_spells_smd_att_boot_sex$t |>
  as_tibble() |>
  rename(
    "male" = 1,
    "female" = 2
...
# extract information
time_in_housing_support_18_19_male_smd <- time_in_housing_support_18_19_model_att_smd[1]
time_in_housing_support_18_19_female_smd <- time_in_housing_support_18_19_model_att_smd[2]
time_in_housing_support_18_19_model_male_smd_se <- time_in_housing_support_18_19_model_att_smd_se$se_male
time_in_housing_support_18_19_model_female_smd_se <- time_in_housing_support_18_19_model_att_smd_se$se_female
time_in_housing_support_18_19_model_male_smd_ci_low <- boot.ci(count_total_housing_spells_smd_att_boot_sex, type = "bca", index = 1)$bca[4]
time_in_housing_support_18_19_model_male_smd_ci_high <- boot.ci(count_total_housing_spells_smd_att_boot_sex, type = "bca", index = 1)$bca[5]
time_in_housing_support_18_19_model_female_smd_ci_low <- boot.ci(count_total_housing_spells_smd_att_boot_sex, type = "bca", index = 2)$bca[4]
time_in_housing_support_18_19_model_female_smd_ci_high <- boot.ci(count_total_housing_spells_smd_att_boot_sex, type = "bca", index = 2)$bca[5]
...
saveRDS(
  ...
  "U:/pyi-paper/output/treatment_effect_results/time_in_housing_support_18_19_subgroup_sex_results_full_match.RDS"
)
...
bootstrap_standardised_mean_difference_aboriginal <- function(pairs, i) {
  ...
  aboriginal_intervention_sd <- weighted_sd(
    x = subset(outcome_data_aboriginal, pyi_flag == 1)$time_in_housing_support_18_19,
    w = subset(outcome_data_aboriginal, pyi_flag == 1)$weights
  )
  
  aboriginal_comparison_sd <- weighted_sd(
    x = subset(outcome_data_aboriginal, pyi_flag == 0)$time_in_housing_support_18_19,
    w = subset(outcome_data_aboriginal, pyi_flag == 0)$weights
  )
  
  non_aboriginal_intervention_sd <- weighted_sd(
    x = subset(outcome_data_non_aboriginal, pyi_flag == 1)$time_in_housing_support_18_19,
    w = subset(outcome_data_non_aboriginal, pyi_flag == 1)$weights
  )
  
  non_aboriginal_comparison_sd <- weighted_sd(
    x = subset(outcome_data_non_aboriginal, pyi_flag == 0)$time_in_housing_support_18_19,
...
# get smd
time_in_housing_support_18_19_model_att_smd_aboriginal <- count_total_housing_spells_smd_att_boot_aboriginal$t0

# get boot se
time_in_housing_support_18_19_model_att_smd_se_aboriginal <- count_total_housing_spells_smd_att_boot_aboriginal$t |>
  as_tibble() |>
  rename(
    "aboriginal" = 1,
    "non_aboriginal" = 2
...
# extract information
time_in_housing_support_18_19_aboriginal_smd <- time_in_housing_support_18_19_model_att_smd_aboriginal[1]
time_in_housing_support_18_19_non_aboriginal_smd <- time_in_housing_support_18_19_model_att_smd_aboriginal[2]
time_in_housing_support_18_19_model_aboriginal_smd_se <- time_in_housing_support_18_19_model_att_smd_se_aboriginal$se_aboriginal
time_in_housing_support_18_19_model_non_aboriginal_smd_se <- time_in_housing_support_18_19_model_att_smd_se_aboriginal$se_non_aboriginal
time_in_housing_support_18_19_model_aboriginal_smd_ci_low <- boot.ci(count_total_housing_spells_smd_att_boot_aboriginal, type = "bca", index = 1)$bca[4]
time_in_housing_support_18_19_model_aboriginal_smd_ci_high <- boot.ci(count_total_housing_spells_smd_att_boot_aboriginal, type = "bca", index = 1)$bca[5]
time_in_housing_support_18_19_model_non_aboriginal_smd_ci_low <- boot.ci(count_total_housing_spells_smd_att_boot_aboriginal, type = "bca", index = 2)$bca[4]
time_in_housing_support_18_19_model_non_aboriginal_smd_ci_high <- boot.ci(count_total_housing_spells_smd_att_boot_aboriginal, type = "bca", index = 2)$bca[5]
...
saveRDS(
  ...
  "U:/pyi-paper/output/treatment_effect_results/time_in_housing_support_18_19_subgroup_aboriginal_results_full_match.RDS"
)
...
bootstrap_standardised_mean_difference_housing_vulnerability <- function(pairs, i) {
  ...
  prior_homelessness_intervention_sd <- weighted_sd(
    x = subset(outcome_data_prior_homelessness, pyi_flag == 1)$time_in_housing_support_18_19,
    w = subset(outcome_data_prior_homelessness, pyi_flag == 1)$weights
  )
  
  prior_homelessness_comparison_sd <- weighted_sd(
    x = subset(outcome_data_prior_homelessness, pyi_flag == 0)$time_in_housing_support_18_19,
    w = subset(outcome_data_prior_homelessness, pyi_flag == 0)$weights
  )
  
  no_prior_homelessness_intervention_sd <- weighted_sd(
    x = subset(outcome_data_no_prior_homelessness, pyi_flag == 1)$time_in_housing_support_18_19,
    w = subset(outcome_data_no_prior_homelessness, pyi_flag == 1)$weights
  )
  
  no_prior_homelessness_comparison_sd <- weighted_sd(
    x = subset(outcome_data_no_prior_homelessness, pyi_flag == 0)$time_in_housing_support_18_19,
...
# get smd
time_in_housing_support_18_19_model_att_smd_prior_homelessness <- count_total_housing_spells_smd_att_boot_prior_homelessness$t0

# get boot se
time_in_housing_support_18_19_model_att_smd_se_prior_homelessness <- count_total_housing_spells_smd_att_boot_prior_homelessness$t |>
  as_tibble() |>
  rename(
...
# extract information
time_in_housing_support_18_19_prior_homelessness_smd <- time_in_housing_support_18_19_model_att_smd_prior_homelessness[1]
time_in_housing_support_18_19_no_prior_homelessness_smd <- time_in_housing_support_18_19_model_att_smd_prior_homelessness[2]
time_in_housing_support_18_19_model_prior_homelessness_smd_se <- time_in_housing_support_18_19_model_att_smd_se_prior_homelessness$se_prior_homelessness
time_in_housing_support_18_19_model_no_prior_homelessness_smd_se <- time_in_housing_support_18_19_model_att_smd_se_prior_homelessness$se_no_prior_homelessness
time_in_housing_support_18_19_model_prior_homelessness_smd_ci_low <- boot.ci(count_total_housing_spells_smd_att_boot_prior_homelessness, type = "bca", index = 1)$bca[4]
time_in_housing_support_18_19_model_prior_homelessness_smd_ci_high <- boot.ci(count_total_housing_spells_smd_att_boot_prior_homelessness, type = "bca", index = 1)$bca[5]
time_in_housing_support_18_19_model_no_prior_homelessness_smd_ci_low <- boot.ci(count_total_housing_spells_smd_att_boot_prior_homelessness, type = "bca", index = 2)$bca[4]
time_in_housing_support_18_19_model_no_prior_homelessness_smd_ci_high <- boot.ci(count_total_housing_spells_smd_att_boot_prior_homelessness, type = "bca", index = 2)$bca[5]
...
saveRDS(
  ...
  "U:/pyi-paper/output/treatment_effect_results/time_in_housing_support_18_19_subgroup_housing_vulnerability_results_full_match.RDS"
)
...
saveRDS(
  ...
  "U:/pyi-paper/output/plot_data/time_in_housing_support_18_19_smd_results_full_match.RDS"
)
